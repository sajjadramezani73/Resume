    ...
    return (
        <div className='w-full md:flex grid grid-flow-col justify-start group'>
            <div className="md:w-44 md:min-w-[176px] md:text-end">
                ...
                <p className="text-xs text-captionLight pt-0.5">{item?.location}</p>
            </div>
            ...
            <div className="pb-7 pt-2 md:pt-0 group-last:pb-0 w-full">
                ...
                <p className="text-sm text-caption dark:text-lightCaption mt-2">{item?.university}</p>
                <p className="text-sm text-caption dark:text-lightCaption mt-2">{item?.grade}</p>
            </div>
        </div>
    )
}
