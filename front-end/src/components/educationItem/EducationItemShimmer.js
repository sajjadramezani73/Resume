...
const EducationItemShimmer = () => {
    return (
        <div className='w-full flex group'>
            <div className="w-44 min-w-[176px] text-end">
                <div className="flex justify-end">
                    <div className="w-10 h-5 rounded-sm bg-gray-100 animate-pulse"></div>
            ...
            <div className="pb-7 group-last:pb-0 w-full">
                <div className="w-40 h-5 rounded-sm bg-gray-100 animate-pulse"></div>
                <div className="w-72 h-5 rounded-sm bg-gray-100 animate-pulse mt-2"></div>
                <div className="w-28 h-5 rounded-sm bg-gray-100 animate-pulse mt-2"></div>
            </div>
        </div>
    )
}

export default EducationItemShimmer