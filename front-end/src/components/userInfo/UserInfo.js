    ...
    return (
        <div className='w-full h-full flex flex-col justify-between items-center pt-20'>
            <div className="text-center">
                ...
                <p className='text-[34px] text-captionDark font-bold mt-6'>{aboutMe?.firstName + ' ' + aboutMe?.lastName}</p>
            ...
            <div className="border-t border-center-image p-4 w-full flex justify-center items-center gap-x-2 hover:gap-x-3 duration-300 cursor-pointer group">
                <p className='text-base text-captionDark font-bold uppercase'>{t.downloadCV}</p>
                <LoadSvgIcon name="download" color="var(--color-captionDark)" size={16} weight={2} />
            </div>
        </div>
    )
}
